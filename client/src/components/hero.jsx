        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className={`space-y-6 ${isLoaded ? "animate-fade-in" : "opacity-0"}`}>
            <div className="space-y-2">
              <div className="inline-block bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-sm font-medium animate-delay-100">
                New Collection
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tighter text-white">
                Elevate Your <span className="text-blue-400">Movement</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-200 max-w-[600px] animate-delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-delay-300">
              <button className="bg-blue-600 text-white px-6 py-3 rounded-md flex items-center gap-2 hover:bg-blue-500 transition-colors shadow-lg">
                Shop Collection
                <ChevronRight className="h-4 w-4" />
              </button>
              <button className="border border-gray-500 text-white px-6 py-3 rounded-md hover:bg-gray-700 transition-colors shadow-lg">
                Explore Featured
              </button>
            </div>
          </div>
          ...
          <div className={`relative flex justify-center ${isLoaded ? "animate-fade-in animate-delay-400" : "opacity-0"}`}>
            <div className="relative w-full max-w-[500px] max-h-[600px]">
              ...
              {/* Glow effects */}
              <div className="absolute top-[-10%] right-[-5%] w-64 h-64 bg-blue-500/10 rounded-full filter blur-3xl z-10"></div>
              <div className="absolute bottom-[-10%] left-[-5%] w-64 h-64 bg-teal-500/10 rounded-full filter blur-3xl z-10"></div>

              {/* Floating Badges */}
              <div className="absolute top-[20%] right-[-10%] bg-gradient-to-r from-blue-500 to-teal-400 w-24 h-24 rounded-full flex items-center justify-center shadow-xl animate-float z-30">
                <img
              ...
              <div className="absolute bottom-[20%] left-[-10%] bg-gradient-to-r from-green-400 to-blue-500 w-24 h-24 rounded-full flex items-center justify-center shadow-xl animate-float z-30 animate-delay-500">
                <img
